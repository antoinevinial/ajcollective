	...
	<div class="panel panel--contact">
		...
		<div class="grid">
			...
			<div class="cell-11 prepend-4">
				<p class="contact__txt">Once upon a time, South African/Londoner  and now Danish imposter, Andrea Jade Colomb had a dream, and that dream was to open 80s Bar in Cuba with a neon pink sign of a Flamingo and drink Caprianas all day. Sadly for her that dream didn’t come true, but lucky for us at AJCollective the next dream did…</p>
				...
				<p class="contact__txt">After 7 years in the business and realising the demand, Andrea went to the look out for other likeminded souls and found Kat (Treatment Writer), Tegan (Creative Researcher), Jody (Creative Reseacher) and Michael (Creative Researcher) who together began to build the foundations of what is now AJCollective.</p>
			</div>
			<div class="cell-11 prepend-2">
				<p class="contact__txt">Over the past three years the company has rocketed in terms of development, and can now boast not only an arsenal of imagery, but also the experience of working and learning from some of the most influential Directors in the industry, Guy Ritchie, Johan Renck, Johnny Green, Martin Werner, Hamish Rothwell, Andreas Nilsson, Pete Riski…. Dougal Wilson to name only a few.</p>
		...
		<div class="grid grid--overflow">
			<div class="prepend-4">
				<h2 class="heading-2 leader-60 trailer-25">Contact</h2>
			</div>
			<div class="cell-11 prepend-4">
